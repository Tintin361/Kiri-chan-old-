...
class FromYoutube(commands.Cog, name="Youtube module"):
    ...
    async def play(self, ctx, *content):
        ...
        self.bot_voice.play(discord.FFmpegPCMAudio(data["url"], **ffmpeg_opts))
    ...
    async def retour_au_debut(self, ctx):
        ...
        try:
            ...
            await ctx.send("Aucune musique n'est joue actuellement.")
            return
        self.bot_voice.play(discord.FFmpegPCMAudio(self.current_url, before_options="-ss 00:00:00.00"))
    ...
    async def cheh(self, ctx):
        ...
        try:
            ...
            pass
        self.bot_voice.play(discord.FFmpegPCMAudio(f"{save_path}cheh.mp3"))
        time.sleep(7)
        await ctx.voice_client.disconnect()
